...
public class LibraryService {
    ...
    public void borrowBook() {
        ...
        borrowHistory.add(
                new BorrowRecord(bookId, memberId, LocalDate.now())
        );
    ...
    public void runPerformanceComparison() {
        ...
        long arrayTime = endArrayTime - startArrayTime;
        ...
        long linkedTime = endLinkedTime - startLinkedTime;

        System.out.println("Performance Comparison Test");
        System.out.println("Adding 1,000 integers (0-1000) to ArrayList and LinkedList.\n");
        System.out.printf("ArrayList Time: %d%nLinkedList Time: %d%n", arrayTime, linkedTime);
    }
