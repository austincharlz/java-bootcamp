...
Log on activate entry: Activate customer request received
Log on activate success for Ravi: Customer Ravi activated successfully
Never log field: Raw email
